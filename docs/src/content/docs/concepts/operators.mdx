...
import inputJson from '/src/content/examples/operators/companies/input.json?raw';
import inputQuery from '/src/content/examples/operators/companies/query.gq?raw';
import outputJson from '/src/content/examples/operators/companies/output.json?raw';
import dotInputQuery from '/src/content/examples/operators/companies/dot-query.gq?raw';
import dotOutputJson from '/src/content/examples/operators/companies/dot-output.json?raw';
