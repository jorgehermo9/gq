...
import productInput from '/src/content/examples/arguments/products/input.json?raw';
import productQuery from '/src/content/examples/arguments/products/query.gq?raw';
import productOutput from '/src/content/examples/arguments/products/output.json?raw';
