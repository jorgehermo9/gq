...
import inputJson from '/src/content/examples/introduction/introduction-input.json?raw';
import inputQuery from '/src/content/examples/introduction/introduction-query.gq?raw';
import outputJson from '/src/content/examples/introduction/introduction-output.json?raw';
...
As you can see, the query language has some similarities with GraphQL, like the JSON-like syntax, the argument definition or the
...
You can learn more about all the language capabilities in the [Usage Section](/usage/first-steps).
